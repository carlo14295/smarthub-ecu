...
class Power(Model):
    ...
    def __init__(self, id=None, name=None, status=None):  # noqa: E501
        """Power - a model defined in OpenAPI

        :param id: The id of this Power.  # noqa: E501
        :type id: int
        :param name: The name of this Power.  # noqa: E501
        :type name: str
        :param status: The status of this Power.  # noqa: E501
        :type status: str
        """
        self.openapi_types = {
            'id': int,
    ...
    @property
    def status(self):
        """Gets the status of this Power.

        Power status  # noqa: E501
